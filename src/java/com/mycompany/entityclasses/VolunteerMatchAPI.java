...
/**
 * Based on VolunteerMatch's code on how to successfully call their API using WSSE authentication
 * source: https://github.com/volunteermatch
 * Provided by Volunteer Match as an example of how to use their public API.
 */


@XmlRootElement
public class VolunteerMatchAPI implements Serializable {

    public static final String HTTP_METHOD_GET = "GET";
    
    private WSSECredentials wsse = null;
    private String accountName;
    private static final Logger log = Logger.getLogger(VolunteerMatchAPI.class);
    ...
    public VolunteerMatchAPI() {
    }

    public VolunteerMatchAPI(String accountName, String password) {
